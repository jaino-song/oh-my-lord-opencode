/**
 * Unified system directive prefix for oh-my-lord-opencode internal messages.
 * All system-generated messages should use this prefix for consistent filtering.
 *
 * Format: [SYSTEM DIRECTIVE: OH-MY-LORD-OPENCODE - {TYPE}]
 */
...
export const SystemDirectiveTypes = {
  ...
  MISSIONARY_CONTINUATION: "MISSIONARY CONTINUATION",
 ...
 * @returns Formatted directive string like "[SYSTEM DIRECTIVE: OH-MY-LORD-OPENCODE - TODO CONTINUATION]"
 */
