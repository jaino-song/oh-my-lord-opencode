...
worker-paul - Autonomous task executor for trivial/small tasks that don't require formal planning.
...
export function createWorkerPaulAgentWithOverrides(
  ...
  const base: AgentConfig = {
    description: override?.description ??
      "worker-paul - Autonomous executor for trivial tasks. No planning required.",
...
export const workerPaulAgent: AgentConfig = {
  description: "worker-paul - Autonomous executor for trivial tasks. No planning required.",
