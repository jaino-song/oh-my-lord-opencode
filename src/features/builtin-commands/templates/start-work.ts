...
3. **Decision logic**:
   - If \`.paul/boulder.json\` exists AND plan is NOT complete (has unchecked boxes):
...
5. **Read the plan file** and start executing tasks according to Paul workflow
...
- Follow Paul delegation protocols (7-section format)`
